...
public class ScrollTabIndicator extends LinearLayout {
    ...
    private int mLineColor = 0xFFe1e1e1;


    private int mTabTextSize = 14;// 指针文字的大小,sp
    private int mTabDefaultColor = 0xFF676767;// 未选中默认颜色
    private int mTabSelectedColor = 0xFF263BA6;// 指针选中颜色
    ...
    private void switchTab(int pos) {
        ...
        Drawable drawableBo = tv.getCompoundDrawables()[3];
        int level = drawableBo.getLevel();
        ...
        tv.getCompoundDrawables()[3].setLevel(1);
    ...
    public void resetPos(int pos) {
        ...
        tv.getCompoundDrawables()[3].setLevel(0);
    ...
    private View generateTextView(String title, int pos) {
        ...
        Drawable drawableBo = getResources().getDrawable(R.drawable.tab_indicator);

        tv.setCompoundDrawablesWithIntrinsicBounds(null, null, null, drawableBo);
        tv.setCompoundDrawablePadding(-20);

        // 将TextView添加到父控件RelativeLayout
        RelativeLayout rl = new RelativeLayout(context);
        RelativeLayout.LayoutParams rlParams = new RelativeLayout.LayoutParams(-2, -1);
