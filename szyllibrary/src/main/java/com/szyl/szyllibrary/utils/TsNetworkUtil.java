        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    TsToastView.normal(context, "切换到wifi环境下").show();
                    break;
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            netType = NETWORK_2G;
                            TsToastView.normal(context, "切换到2G环境下").show();
                            break;
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            TsToastView.normal(context, "切换到3G环境下").show();
                            break;
                        case TelephonyManager.NETWORK_TYPE_LTE:

                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
                            TsToastView.normal(context, "切换到4G环境下").show();
                            break;
                        default:
                            ...
                            TsToastView.normal(context, "未知网络").show();
                    }
                    break;
                default:
                    netType = 5;
            ...
            TsToastView.error(context, "当前无网络连接").show();
        }
        return netType;
    }
