...
public class TsDeviceUtil {
    ...
    public static void callPhone(final Context context, String phoneNumber) {
        if (!TsDataUtil.isNullString(phoneNumber)) {
    ...
    public static void sendSms(Context context, String phoneNumber, String content) {
        Uri uri = Uri.parse("smsto:" + (TsDataUtil.isNullString(phoneNumber) ? "" : phoneNumber));
        Intent intent = new Intent(Intent.ACTION_SENDTO, uri);
        intent.putExtra("sms_body", TsDataUtil.isNullString(content) ? "" : content);
    ...
    public static List<HashMap<String, String>> getAllContactInfo(Context context) {
        ...
        while (cursor.moveToNext()) {
            ...
            // 判断contact_id是否为空
            if (!TsDataUtil.isNullString(contact_id)) {//null   ""
     ...
     * 根据实际情况自行调整
     */
    public static String getMessageInPhone(Context mContext) {
