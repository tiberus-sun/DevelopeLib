...
import static com.szyl.szyllibrary.utils.TsConstUtil.BYTE;
import static com.szyl.szyllibrary.utils.TsConstUtil.GB;
import static com.szyl.szyllibrary.utils.TsConstUtil.KB;
import static com.szyl.szyllibrary.utils.TsConstUtil.MB;
...
public class TsDataUtil {
     ...
     */
    public static double byte2Size(long byteNum, TsConstUtil.MemoryUnit unit) {
        if (byteNum < 0) {
            return -1;
        }
        switch (unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, TsConstUtil.MemoryUnit unit) {
        if (size < 0) {
            return -1;
        }
        switch (unit) {
