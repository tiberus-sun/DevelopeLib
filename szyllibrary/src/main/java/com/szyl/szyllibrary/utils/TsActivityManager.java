...
/**
 * Created by tiberus on 2018/11/30.
 * activity 管理类
 */
...
public class TsActivityManager {
    ...
    private static TsActivityManager sManager;
    private Stack<WeakReference<Activity>> mActivityStack;

    public static TsActivityManager getManager() {
        if (sManager == null) {
            synchronized (TsActivityManager.class) {
                if (sManager == null) {
                    sManager = new TsActivityManager();
                }
            }
        }
        return sManager;
