 ...
 * 点击有阴影动画效果的button
 */
public class TsPaperButton extends View {

    private static final String TAG = TsPaperButton.class.getSimpleName();
    ...
    public TsPaperButton(Context context) {
        this(context, null);
    }

    public TsPaperButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("NewApi")
    public TsPaperButton(Context context, AttributeSet attrs, int defStyleAttr) {
