...
public class TsCircleProgressBar extends View {
    ...
    private float curSpeedSize = dipToPx(24);
    ...
    private String unitColor = "#575757";
    private String contentColor = "#037BFF";
    private String longDegreeColor = "#111111";
    private String shortDegreeColor = "#111111";
    private int bgArcColor = Color.parseColor("#9982AEF5"); //圆圈背景色
    ...
    public TsCircleProgressBar(Context context) {
        super(context, null);
        initView();
    }

    public TsCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        initCofig(context, attrs);
        initView();
    }

    public TsCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//显示标题文字
        ...
        curSpeedPaint.setColor(Color.parseColor(unitColor));
...
//当前进度
        ...
        if (isNeedContent) {
            ...
            canvas.drawText(String.format("%.0f", curValues/maxValues*100)+"%", centerX, centerY + textSize / 3, vTextPaint);
        }
        if (isNeedUnit) {
            canvas.drawText(unitString, centerX, centerY + 4 * textSize / 5, unitPaint);
        }
        if (isNeedTitle) {
            canvas.drawText(titleString, centerX, centerY - 4 * textSize / 5, curSpeedPaint);
        }
