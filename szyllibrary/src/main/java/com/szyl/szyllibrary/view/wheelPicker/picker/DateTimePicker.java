...
public class DateTimePicker extends WheelPicker {
    ...
    protected View makeCenterView() {
        ...
        yearView.setTextOptionSize(textOptionSize);
        yearView.setMyPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        ...
        monthView.setTextOptionSize(textOptionSize);
        monthView.setMyPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        ...
        dayView.setTextOptionSize(textOptionSize);
        dayView.setMyPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        ...
        hourView.setTextOptionSize(textOptionSize);
        hourView.setMyPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        ...
        minuteView.setTextOptionSize(textOptionSize);
        minuteView.setMyPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
