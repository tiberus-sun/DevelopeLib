...
public class TsDialog extends Dialog {
    ...
    public TsDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public TsDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
     ...
     */
    public TsDialog(Context context, float alpha, int gravity) {
        super(context);
