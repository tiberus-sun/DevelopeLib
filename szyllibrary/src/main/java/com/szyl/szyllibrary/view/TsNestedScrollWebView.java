...
/**
 * 解决NestedScrollView 中嵌webview 冲突问题
 * 问题1 空白
 * 问题2 View not displayed because it is too large to fit into a software layer
 */
public class TsNestedScrollWebView extends WebView implements NestedScrollingChild {
    ...
    public TsNestedScrollWebView(Context context) {
        super(context);
        init();
    }

    public TsNestedScrollWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TsNestedScrollWebView(Context context, AttributeSet attrs, int defStyleAttr) {
