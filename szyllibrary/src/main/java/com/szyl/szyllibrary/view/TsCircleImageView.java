 ...
 *
 */
public class TsCircleImageView extends AppCompatImageView {
    ...
    //构造方法
    public TsCircleImageView(Context context){
        this(context, null);
    }
    public TsCircleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
