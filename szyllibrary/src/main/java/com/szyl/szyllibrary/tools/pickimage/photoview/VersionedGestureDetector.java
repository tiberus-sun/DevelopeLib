package com.szyl.szyllibrary.tools.pickimage.photoview;
			...
			switch (ev.getAction()) {
				...
				case MotionEvent.ACTION_MOVE: {
					...
					if (!mIsDragging) {
						...
						// touch slop
						mIsDragging =(Double)(Math.sqrt((dx * dx) + (dy * dy))) >= mTouchSlop;
			...
			switch (action & MotionEvent.ACTION_MASK) {
				...
				case MotionEvent.ACTION_POINTER_UP:
					...
					if (pointerId == mActivePointerId) {
						// This was our active pointer going arrow_up. Choose a new
